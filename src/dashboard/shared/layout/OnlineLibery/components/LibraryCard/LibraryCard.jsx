...
const LibRaryClass = () => {
    ...
    useEffect(() => {
      const filteredBooks =  data.filter((value) => value.grade == libraryId.replace(":", "") || value.subject.toLowerCase().includes(libraryId.replace(":", "").toLowerCase()))
    ...
    return (
        <div className={classes['container']}>
                        ...
                        return (
                            <div className={classes['card']} id={e.id} key={index}>
                                ...
                                <div className={classes['icons']}>
                                    <button className={classes['editBtn']} onClick={() => handleEdit(e.id)}>
                                        <Icon icon="carbon:edit" className={classes['iconsBtn']} />
                                        <p>Edit</p>
                                    </button>
                                    <button className={classes['deleteBtn']} onClick={() => dataDelete(e.id)} >
            ...
            {isOpen && <LiberyModal save={save} isOpen={isOpen} setIsOpen={setIsOpen} />}
            {isEditOpen && <LiberyEditModal edit={edit}
